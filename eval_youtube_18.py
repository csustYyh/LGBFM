...
parser.add_argument('--model', default='my_saves/3080Ti/Apr15_11.30.33_retrain_s03_220000.pth')
parser.add_argument('--yv_path', default='/datanew/vos-datasets/YouTube2018')
...
parser.add_argument('--output', default='./output/yt2018')
