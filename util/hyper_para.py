...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--davis_path', default='/home/guiyan/dataset/Yyh/vos-datasets/DAVIS/2017')
        parser.add_argument('--csv_path', default='output/csv')
        parser.add_argument('--output', default = 'output')
        parser.add_argument('--ckpt_output', default = 'output/ckpt')
        ...
        # Data parameters
        parser.add_argument('--static_root', help='Static training data root', default='/datanew/vos-datasets/static_data')
        parser.add_argument('--bl_root', help='Blender training data root', default='../BL30K')
        parser.add_argument('--yv_root', help='YouTubeVOS data root', default='/datanew/vos-datasets/YouTube')
        parser.add_argument('--davis_root', help='DAVIS data root', default='/datanew/vos-datasets/DAVIS')
        ...
        if self.args['stage'] == 0:
            ...
            # self.args['steps'] = none_or_default(self.args['steps'], [75000])
            ...
            self.args['batch_size'] = none_or_default(self.args['batch_size'], 4)
            self.args['iterations'] = none_or_default(self.args['iterations'], 150000)
            # self.args['iterations'] = none_or_default(self.args['iterations'], 300000) # 再次训练找最好模型 
