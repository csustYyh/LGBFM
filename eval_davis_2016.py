...
parser.add_argument('--model', default='my_saves/Jan11_12.49.31_retrain_s03/Jan11_12.49.31_retrain_s03_290000.pth')
parser.add_argument('--davis_path', default='/datanew/vos-datasets/DAVIS/2016')
parser.add_argument('--output', default='./output/16val')
